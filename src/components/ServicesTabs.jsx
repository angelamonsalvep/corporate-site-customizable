        ...
        <div className="tabs-container">
          ...
          <div className="tabs-content">
                    ...
                    return (
                      <div className="product-card" key={product.id}>
                        <div className="product-image">
                          <img src={product.image} alt={info.name} />
                        </div>
            ...
            {activeTab === 'financial' && (
              <div className="tab-pane animate-fade-in">
                <div className="tab-intro">
                  <h3>{t('financial.title')}</h3>
                  <p>{t('financial.desc')}</p>
                </div>
                      ...
                      >
                        {service.image ? (
                          <div className="service-image">
                            <img src={service.image} alt={info.name} />
                          </div>
                        ) : (
                        ...
                        <div className="service-info">
                          ...
                          <h4>{info.name}</h4>
                          <p>{info.desc ? (info.desc.length > 100 ? info.desc.substring(0, 100) + '...' : info.desc) : t('services.details')}</p>
                          <span className="read-more">{t('services.details')}</span>
                        </div>
                      </div>
                    );
                  })}
              ...
              <div className="modal-header">
                {selectedService.image && (
                  <div className="modal-image">
                    <img src={selectedService.image} alt={info.name} />
                  </div>
                )}
                <h3>{info.name}</h3>
              </div>
